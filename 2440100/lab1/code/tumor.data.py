...
# 加载data文件，类型为浮点，分隔符为逗号，对第七列也就是data 中的传染病类别这一列的字符串转换为0-2 的浮点数
data = np.loadtxt(file_path, dtype=float, delimiter=',', converters={7:tumor_type})
# print(data[0])

# 对data 矩阵进行分割，从第七列包括第七列开始后续所有列进行拆分
